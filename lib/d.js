    ...
    create: function(path, data, ext) {
      ...
      if (!sub) {
        ...
        sub.add = function(ctx, options) {
          ...
          if (ext.temporary) {
            onstop = function() {
              d.subs.remove(_this.id);
              return _this.stopListening(ctx);
            };
            this.listenTo(ctx, "stop", onstop);
            return this.listenTo(ctx, "run:before", onstop);
          }
        };
